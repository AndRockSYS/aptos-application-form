        ...
        <div className='transparent-background'>
            <section className='approvement-form'>
                ...
                <article className='company'>
                    ...
                    <h3>Registration Number: {company.registrationNumber}</h3>
                    <h3>Country: {company.country}</h3>
                    <h3>
                        Business Type:
                        {company.type == BusinessType.Services ? 'Services' : 'Trade'}
                    </h3>
                </article>
                <article className='address'>
                    <h2>Business Address</h2>
                    <h3>Street Address: {address.street}</h3>
                    <h3>Street Address Line 2: {address.street2 ? address.street2 : 'None'}</h3>
                    <h3>City: {address.city}</h3>
                    <h3>State / Province: {address.state}</h3>
                    <h3>Postal / Zip Code: {address.postalCode}</h3>
                </article>
                ...
                {isApproved ? (
                    ...
                    <div>
                        <button
                            id='green-button'
                            onClick={() => reviewApplication(applicant, true)}
                        >
                            Approve
                        </button>
